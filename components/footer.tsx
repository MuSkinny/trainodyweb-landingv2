                    ...
                    <div className="mt-3 flex items-center gap-3">
                        ...
                        <a href="https://www.instagram.com/trainody.app" target="_blank" className="transition-opacity hover:opacity-80">
                            <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M24.0012 19.7334C26.3575 19.7334 28.2679 21.6436 28.2679 24.0001C28.2679 26.3564 26.3575 28.2668 24.0012 28.2668C21.6446 28.2668 19.7345 26.3564 19.7345 24.0001C19.7345 21.6436 21.6446 19.7334 24.0012 19.7334Z" fill="white"/>
                            </svg>
                        </a>
                        {/* facebook 
                        <a href="#" target="_blank" className="transition-opacity hover:opacity-80">
                        <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
